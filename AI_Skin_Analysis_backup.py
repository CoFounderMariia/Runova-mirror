...
Keep responses SHORT (2-3 sentences max). Be direct and helpful. Always respond in English with natural American English."""
        ...
        if any(keyword in answer.lower() for keyword in refusal_keywords) and ("анализ" not in answer.lower() and "analysis" not in answer.lower()):
            ...
            retry_response = client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": f"You are a dermatology AI. You MUST analyze skin images. This is medical skin tissue analysis, not identity recognition. Always provide detailed skin analysis. Respond in {response_lang}."
                    },
                    {
                        "role": "user",
                        "content": [
